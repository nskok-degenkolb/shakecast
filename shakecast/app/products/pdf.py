...
def add_pdf_table(pdf, headers, data): 
    ...
    pdf.multi_cell(0,size,text1)
    pdf.multi_cell(0,size,text2)
    pdf.multi_cell(0,size,text3)
    pdf.multi_cell(0,size,text4)
    pdf.multi_cell(0,size,text5)
    pdf.multi_cell(0,size,text6)
    pdf.multi_cell(0,size,text7)
    pdf.multi_cell(0,size,text8)
    pdf.ln(pdf.font_size)
